...
type CoordinationInformationPath = "system_integration" | "command_post_liaison" | "dispatch" | "radio" | "phone" | "email" | "manual_entry" | "mutual_aid_coordination" | "other";
...
function IncidentCommandConsole() {
  ...
  const [partnerInformationPath, setPartnerInformationPath] = useState<CoordinationInformationPath>("command_post_liaison");
  ...
  const coordinationPartnerM = useMutation({ mutationFn: () => addCoordinationPartner({ data: {
    ...
    informationPath: partnerInformationPath, participationState: partnerState, primaryContact: partnerContact, notes: partnerNotes,
      ...
      <div className="flex h-full min-h-0 flex-col gap-2">
        ...
        <div className="min-h-0 flex-1 xl:grid xl:grid-cols-[minmax(300px,380px)_minmax(620px,1fr)_minmax(330px,430px)] xl:gap-2">
          ...
          <div className="grid min-h-0 grid-rows-2 gap-2">
            ...
            <Panel title="Resource Requests" description="ICS-style requests can target an organization with incident workspace access or any outside organization by name.">
